{{-- Закріплена внизу й видима постійно (ТЗ, п. 14).
     ...
     Панель є в розмітці навіть при порожньому кошику, але прихована: після
     додавання дня без перезавантаження JS її просто показує. --}}
<div class="fixed inset-x-0 bottom-0 z-20 border-t border-ink-200 bg-white/95 shadow-[0_-4px_16px_rgba(0,0,0,0.06)] backdrop-blur"
     data-cart-filled @if ($count === 0) hidden @endif>
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="leading-tight">
                ...
                <div class="text-lg font-bold tabular-nums">
                    ...
                    <span class="text-sm font-semibold text-ink-500">грн</span>
                </div>
            </div>
        </div>
